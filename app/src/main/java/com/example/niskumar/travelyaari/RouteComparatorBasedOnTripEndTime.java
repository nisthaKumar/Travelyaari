...
public class RouteComparatorBasedOnTripEndTime implements Comparator<Route> {
    @Override
    public int compare(Route route1, Route route2) {
        try {
            Date date1 = convertStringToDate(route1.getTrip_end_time());
            Date date2 = convertStringToDate(route2.getTrip_end_time());
